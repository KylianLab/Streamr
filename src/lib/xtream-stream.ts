...
/**
 * Shared handler for /movie/ and /series/ xtream streaming routes.
 * Resolves mediaFile by UUID or numeric hash, then streams (local or proxy).
 */
export async function handleXtreamStream(
  req: NextRequest,
